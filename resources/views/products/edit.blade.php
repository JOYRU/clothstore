                        ...
                        <form class="form-horizontal" action="{{route('product.update',$product->id)}}" method='post'>
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <input type="text " class="form-control" id="product_size" placeholder="Enter product_size" value="{{$product->product_size}}" name="product_size">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <textarea class="form-control" rows = "2" id="product_description" placeholder="Enter product_description"  name="product_description">{{$product->product_description}}</textarea>
                              </div>
                            </div>
